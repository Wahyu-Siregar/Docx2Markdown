...
import { Sliders, ChevronDown, ChevronUp, Folder, FileType, CheckSquare } from 'lucide-react';
    ...
    <div className="w-full glass-panel rounded-2xl border border-slate-800 shadow-xl overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-white">Pengaturan & Opsi Lanjutan</h3>
            <p className="text-xs text-slate-400">Atur direktori gambar, fallback tabel, penanganan caption, dan line ending</p>
          </div>
        </div>
      ...
      {isOpen && (
        <div className="p-6 border-t border-slate-800 grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-950/40">
          {/* Image Folder Name */}
          <div>
          ...
          {/* Checkbox Options */}
          <div className="md:col-span-2 space-y-3 pt-2 border-t border-slate-800/60">
